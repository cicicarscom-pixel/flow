...
const getBadge = (status) => {
  switch (status) {
    case 'paid': return { bg: 'rgba(75, 226, 119, 0.2)', text: '#4be277', label: 'Ödendi' };
    case 'partial': return { bg: 'rgba(255, 180, 171, 0.2)', text: '#ffb4ab', label: 'Bekliyor' };
    case 'unpaid': return { bg: 'rgba(255, 138, 131, 0.2)', text: '#ff8a83', label: 'Devretti' };
